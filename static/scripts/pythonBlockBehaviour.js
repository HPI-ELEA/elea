...
Blockly.Python["experimental_timer"] = function (block) {
    ...
    // TODO: Implement this
    let code = "# not implemented in python yet";
...
Blockly.Python["ea_init"] = function (block) {
    ...
    Blockly.Python.provideFunction_('import_libraries',['import random\nimport math']);
    Blockly.Python.provideFunction_('mainFunction',[
        "def " + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ + " ():\n" +
        globals + statementsSimulationSteps
    ]);
...
Blockly.Python["jump_k"] = function (block) {
    ...
    var k = Blockly.Python.valueToCode(
        block,
        "K",
        Blockly.Python.ORDER_ATOMIC
    ); // TODO: cache
...
Blockly.Python["init_uniform"] = function () {
    var functionName = Blockly.Python.provideFunction_(
        ...
        [
            "def " + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ + "():",
            "   fullArray = [0] * _C2_B5", // TODO: replace fill for ES5
...
Blockly.Python["init_constant"] = function (block) {
    ...
    var functionName = Blockly.Python.provideFunction_("zeroInitPopulation", [
        "def " + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ + "():",
        "   fullArray = [[" + dropdownConstant + "for x in range(genome_length)] for y in range(_C2_B5)]",
        "   return fullArray",
    ]);
    var code = functionName + "()";
    return [code, Blockly.Python.ORDER_FUNCTION_CALL];
...
Blockly.Python["run_loop"] = function (block) {
    ...
    var code = loopVar + " = 0\n";
    code += "while ((" + continueCondition +") and " + loopVar + " < " + exitNumber + "):\n";
...
Blockly.Python["run_loop_logging"] = function (block) {
    ...
    var run = Blockly.Python.valueToCode(
        block,
        "run",
        Blockly.Python.ORDER_NONE
    );
...
Blockly.Python["ea_addtopopulation"] = function (block) {
    ...
    if (dropdownSelectionStrategy == "FITNESS") {
        code +=
            "sorted(" + POPULATION + ",key=lambda x: fitness(x))[0:" +
            length +
            "]";
...
Blockly.Python["max_diversity"] = function (block) {
    ...
    var functionMaxDiversity = Blockly.Python.provideFunction_(
        "maxDiversity",
        [
            "def " +
            Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.Python["ea_mutate_bit"] = function (block) {
    ...
    var code = "ind_index = floor(random.random() * genome_length\n" +
        variableIndividual +
        "[ind_index] = 1 - " +
        variableIndividual +
        "[ind_index]"
...
Blockly.Python["sample_normal_positive"] = function (block) {
    ...
    var functionName = Blockly.Python.provideFunction_(
        ...
        [
            "def " + Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ + "():",
            "   sample = 0",
            "   while (sample <= 0) sample = math.round(random.normal(loc="+ variableMean + ",scale=" +  variableVariance +  "))",
            "   return sample",
        ]
    );
    var code = functionName + "()";
...
Blockly.Python["ea_debug"] = function (block) {
    ...
    // TODO: Add new line characters if the logging_variable is a two-dimensional array
...
Blockly.Python["ea_crossover_onepoint"] = function () {
    var functionCrossover = Blockly.Python.provideFunction_(
        "crossoverOnepoint",
        [
            "def " +
            Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.Python["ea_crossover_uniform"] = function () {
    var functionCrossover3 = Blockly.Python.provideFunction_(
        "crossoverUniform",
        [
            "def " +
            Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ +
...
//TODO: Add the python implementation
Blockly.Python["wait"] = function (block) {
    var waitPeriod = block.getFieldValue("PERIOD");
    var functionName = Blockly.Python.provideFunction_("sleep", [
        "function " +
        Blockly.Python.FUNCTION_NAME_PLACEHOLDER_ +
        "(wait_period) {",
        "   const date = Date.now();",
